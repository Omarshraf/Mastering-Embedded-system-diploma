...
Startup/startup_stm32f103c6tx.o: ../Startup/startup_stm32f103c6tx.s
	arm-none-eabi-gcc -gdwarf-2 -mcpu=cortex-m3 -g3 -c -I"E:/Embedded system (KS)/term 3/Unit 15_Create your Own RTOS_not complete/3-Create Your own RTOS Scheduler PART 1/My_RTOS/DRIVERS2(+EXTI)/EXTI DRIVER/MY_RTOS/inc" -x assembler-with-cpp -MMD -MP -MF"Startup/startup_stm32f103c6tx.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@" "$<"
